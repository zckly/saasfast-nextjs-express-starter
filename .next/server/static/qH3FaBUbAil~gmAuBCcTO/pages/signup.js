...
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22);
  ...
  _createClass(Signup, [{
    ...
    value: function submitSignup(evt) {
      ...
      if (~stateCopy.username.length || ~stateCopy.password.length || ~stateCopy.v_password.length) {
        sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_5___default()({
          title: 'Darn',
      ...
      if (stateCopy.password === stateCopy.v_password) {
        fetch(_settings__WEBPACK_IMPORTED_MODULE_4__[/* domain */ "a"] + '/register', {
          headers: {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_static_template__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Signup));
