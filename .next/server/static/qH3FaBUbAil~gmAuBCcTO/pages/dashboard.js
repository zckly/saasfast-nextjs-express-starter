...
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(next_link__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5);
/* harmony import */ var semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19);
...
function (_React$Component) {
  ...
  _createClass(Dashboard, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.isLoggedIn) {
        fetch(_settings__WEBPACK_IMPORTED_MODULE_5__[/* domain */ "a"] + '/fetch_dashboard', {
          headers: {
    ...
    value: function turnOnAlert(id) {
      ...
      console.log(id);
      fetch(_settings__WEBPACK_IMPORTED_MODULE_5__[/* domain */ "a"] + '/queries/activate', {
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
        },
    ...
    value: function turnOffAlert(id) {
      ...
      console.log(id);
      fetch(_settings__WEBPACK_IMPORTED_MODULE_5__[/* domain */ "a"] + '/queries/deactivate', {
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
        },
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_static_secure_template__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(Dashboard));
